...
const Greeting = () => {
    return (
        <section id="home" className='bg-blue-100 py-24  '>
            <div className='align-element grid  md:grid-cols-2 items-center gap-8'>
                <article>
                    <h1 className='lg:text-7xl md:text-3xl text-xl text-blue-900 font-bold tracking-wider'>Blake.</h1>
                    <p className='mt-4 lg:text-3xl md:text-2xl text-2xl text-slate-800 capitalize tracking-wide'>
